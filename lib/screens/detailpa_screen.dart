...
import 'package:SimhegaM/screens/list/uslap_list.dart';
...
class DetailPAScreen extends StatefulWidget {
  final String token;
  final String pgnJns;
  final String uslIdEx;
  final int selectedIndex;
  final int selectedIndexD;
  const DetailPAScreen(
      {required this.token,
  ...
  @override
  State<DetailPAScreen> createState() => _DetailPAScreenState();
}

class _DetailPAScreenState extends State<DetailPAScreen>
  ...
  List<Widget> listTab = const [
    ...
    Tab(
      child: Text('Penggunaan Anggaran'),
    ),
  ];

  List<Widget> listTabC = [];
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            AwesomeDialog(
                                                ...
                                                title: 'Menyetujui',
                                                desc: 'Mengirim Proposal',
                                                btnCancelOnPress: () {},
                                                btnOkOnPress: () async {
                                                  final result = await service
                                                      .uslSend(hibah!.uslIdEx);
